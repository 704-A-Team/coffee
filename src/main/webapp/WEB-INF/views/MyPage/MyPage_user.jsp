...
<style>
  ...
  .form-section-title{
    ...
    padding-left:12px;
    margin:6px 0 24px;
    font-weight:700; font-size:1.8rem; color:var(--dark-brown);
  }
  ...
  .profile-img{ width:100%; height:260px; object-fit:cover; }
                  ...
                  <div class="profile-box">
					  <c:choose>
					    <c:when test="${empDto.emp_dept_code == 1000}">
					      <img src="${pageContext.request.contextPath}/resources/image/young.jpg"
					           alt="영업부"
					           class="img-thumbnail profile-img">
					    </c:when>
					    <c:when test="${empDto.emp_dept_code == 1001}">
					      <img src="${pageContext.request.contextPath}/resources/image/sang.jpg"
					           alt="생산관리팀"
					           class="img-thumbnail profile-img">
					    </c:when>
					    <c:when test="${empDto.emp_dept_code == 1002}">
					      <img src="${pageContext.request.contextPath}/resources/image/je.jpg"
					           alt="재고팀"
					           class="img-thumbnail profile-img">
					    </c:when>
					    <c:when test="${empDto.emp_dept_code == 1003}">
					      <img src="${pageContext.request.contextPath}/resources/image/in.jpg"
					           alt="인사팀"
					           class="img-thumbnail profile-img">
						</c:when>
						<c:when test="${empDto.emp_dept_code == 1004}">
					      <img src="${pageContext.request.contextPath}/resources/image/gu.jpg"
					           alt="구매팀"
					           class="img-thumbnail profile-img">
						</c:when>
						<c:when test="${empDto.emp_dept_code == 1005}">
					      <img src="${pageContext.request.contextPath}/resources/image/pan.jpg"
					           alt="판매팀"
					           class="img-thumbnail profile-img">
						</c:when>					           
