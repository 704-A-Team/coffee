...
<div class="d-flex flex-grow-1">
    ...
    <div class="flex-grow-1 p-4">
        <div class="report-card shadow-sm">
            ...
            <form id="mfgReportForm" action="${pageContext.request.contextPath}/km/mfgReportUpdate" method="post" class="w-100">
                <!-- Hidden Inputs -->
                ...
                <!-- 버튼 -->
                <div class="btn-row">
                    <button type="submit" class="btn btn-success">보고 수정</button>
