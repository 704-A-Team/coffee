...
<script type="text/javascript">
	...
	function empWriteBtn() {
		// var empno = $('#empno').val();
		// var snedData = JSON.stringify($('#empTrans').serialize());
		// alert('snedData-->'+snedData);
